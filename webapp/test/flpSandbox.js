		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Loja Fiori",
									"targetURL": "#vcd94xt10zfioriecofiorieco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vcd94xt10zfioriecofiorieco-display": {
								"semanticObject": "vcd94xt10zfioriecofiorieco",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vcd94xt10z.fiorieco.fiorieco",
									"url": sap.ui.require.toUrl("vcd94xt10z/fiorieco/fiorieco")
								}
							}
						}
					}
